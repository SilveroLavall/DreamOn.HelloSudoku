...
namespace DreamOn.HelloSudokuLib;
...
public class SudokuEngine_20250130(RunProperties runProperties)
{
    public RunProperties RunProperties { get; set; } = runProperties;
    public Engine Engine { get; set; } = new();
    public IntervalResult[] StartProcessingSudokuPuzzles()
    {
...
public class SudokuPuzzle(short[] puzzleBinary)
{
...
public class SudokuResponse(string sudokuTactics, SudokuRequest sudokuRequest, SudokuSolution sudokuSolutions)
{
