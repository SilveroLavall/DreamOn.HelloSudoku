...
internal class SudokuEngine_20250130(RunProperties runProperties)
{
    ...
    internal void StartProcessingFile()
    {
        ...
        foreach (var inputLine in inputLines.Skip(1 + RunProperties.SkipInputLines).Take(RunProperties.TakeInputLines))
        {
            ...
            {
                Console.WriteLine(new IntervalResult(RunResult, response).ToJson());
            }
        }
